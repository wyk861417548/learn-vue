...
##### initState（src/instance/state.js）
```
...
##### initData（src/instance/state.js）
```
// 初始化data
...
```
##### observe（数据劫持 getter:dep依赖收集 + setter:dep.notify通知更新）（src/observer/index.js）
```
